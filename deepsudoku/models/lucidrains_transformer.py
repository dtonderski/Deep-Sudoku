...
def main():
    sudoku = torch.rand((1, 1, 9, 9))
    vit = ViT(image_size=(9, 9), patch_size=(1, 1), num_classes=1, dim=512,
              depth=6, heads=8, mlp_dim=2048, channels=1)
    print([x.shape for x in vit(sudoku)])
