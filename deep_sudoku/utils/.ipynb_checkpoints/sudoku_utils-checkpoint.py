...
def make_random_moves(board: np.ndarray, solved: np.ndarray, n_valid_moves: int, n_invalid_moves: int = 0) -> np.ndarray:
    """
    ...
    if n_valid_moves > 0:
        ...
        new_board[valid_moves[:, 0], valid_moves[:, 1]] = solved[valid_moves[:, 0], valid_moves[:, 1]]
