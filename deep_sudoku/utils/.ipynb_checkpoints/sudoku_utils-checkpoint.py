...
def make_random_move(board: np.ndarray, solved: np.ndarray, valid_move: str = True) -> np.ndarray:
    """
    Function that takes in an unsolved and a solved board and makes a valid or invalid random move.
    """
    ...
    correct_number = int(solved[move[0], move[1]])
    ...
    temp_board[move[0], move[1]] = new_number
